...
export const metadata = {
  title: "Cultivating a RAG System",
  description:
    "Building and maintaining a high-quality Retrieval-Augmented Generation (RAG) system is like cultivating a garden. It requires constant attention and care to flourish, but with the right approach, it can be both manageable and rewarding.",
  openGraph: {
    title: "Cultivating a RAG System",
    description:
      "Building and maintaining a high-quality Retrieval-Augmented Generation (RAG) system is like cultivating a garden. It requires constant attention and care to flourish, but with the right approach, it can be both manageable and rewarding.",
    ...
    images: [
      {
        url: "https://storage.googleapis.com/generic-assets/blog-static-assets/cultivating-a-rag-system.png",
        alt: "Cultivating a RAG System",
      },
    ],
...
<PublishData
  date={metadata.openGraph.publishedTime}
  authors={metadata.authors}
/>
<br />
![Cultivating a RAG
System](https://storage.googleapis.com/generic-assets/blog-static-assets/cultivating-a-rag-system.png)
...
The foundation of a RAG system is the retrieval. The documents retrieved for a given conversation or query must be _relevant_ and _limited_. All the documents used in generation must be related to the users query, and they must be the **most** relevant of all the documents (and _only_ the most relevant, you don't want to pollute the prompt with unnecessary information).
